                    ...
                    with h_cols[i % 3]:
                        ...
                        if was_sent:
                            ...
                            sent_html = (f'<div class="sent-box">'
                                         f'📤 Last sent: <b>{last["date_sent"]}</b> at <b>{last["price_sent"]}</b> '
                                         f'({last["board"]})'
                                         f'{"<br><a href="+chr(34)+last[chr(34)url"+chr(34)+">View email</a>" if last.get("url") else ""}'
                                         f'</div>')
                            # Build sent_html safely
